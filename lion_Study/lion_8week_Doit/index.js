...
while(computer !== player) {
  player = parseInt(prompt("1부터 100 사이의 숫자를 추측해보세요."));

  if(player < computer) {
    console.log(player + ", up, 숫자를 더 높여보세요")
  }
}
...
//김채현
//object를 이용해서 경기날짜 & 상대팀명 & 두산팀점수를 저장하고, prompt를 이용해서 사용자가 날짜를 입력하면 [?월 ?일 ?대 ?으로 ?한테 (이겼다/졌다)]를 출력하는 